...
#define EMC_JOINT_SET_MIN_OUTPUT_LIMIT_TYPE           ((NMLTYPE) 109)
#define EMC_JOINT_SET_MAX_OUTPUT_LIMIT_TYPE           ((NMLTYPE) 110)
...
#define EMC_JOINT_SET_OUTPUT_TYPE                     ((NMLTYPE) 130) //FIXME-AJ: investigate removal
#define EMC_JOINT_LOAD_COMP_TYPE                      ((NMLTYPE) 131)
// gap because of deleted message type (EMC_AXIS_ALTER_TYPE)
#define EMC_JOINT_SET_STEP_PARAMS_TYPE                ((NMLTYPE) 133)
...
extern int emcJointSetInterpolationRate(int joint, int rate);
...
extern int emcJointSetMinOutputLimit(int joint, double limit);
extern int emcJointSetMaxOutputLimit(int joint, double limit);
...
extern int emcJointSetOutput(int joint, double output);
